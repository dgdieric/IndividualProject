...
<?php
    ...
    if ( !empty($_POST)) {
        ...
        Database::disconnect();
        header("Location: movie_reviews_admin.php?movie_id=$movie_id");
    }
?>
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
					...
					<!-- Ask admin if they really want to delete the review -->
                    <form class="form-horizontal" action="delete_review.php?movie_id=<?php echo $movie_id?>&review_id=<?php echo $review_id?>" method="post">
